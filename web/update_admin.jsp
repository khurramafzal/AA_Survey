...
<tr>
<td>First Option</td>
<td><input type="text" name="f_option" /></td>
</tr>

<tr>
<td>Second Option</td>
<td><input type="text" name="s_option" /></td>
</tr>

<tr>
<td>Third Option</td>
<td><input type="text" name="t_option" /></td>
</tr>

<tr>
<td>Fourth Option</td>
<td><input type="text" name="fo_option" /></td>
</tr>
     
<a href="UserHandlerSurvey?action=add_options&quesid=<%=user.getquestionID()%>">Update</a>
